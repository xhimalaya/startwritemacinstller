...
def create_guideline(n):
    ...
    ### for size changing#####
    SW_global.top = sl_t
    SW_global.bottom = sl_b #-0.15 # (x0,yo,width,height) # change in SW_global.buttom for height change in selector sl_b-0.15
    mainselector.extents = (SW_global.left, SW_global.right, SW_global.bottom, SW_global.top)
...
def call_multigudeline():
    ...
    print(call_g)
    newCreateGuideLine(call_g,None,None,None,None)
...
####### This stoke arrow for multiple guide line #######
...
def composite_dot_multiple_guideline(a,b,c,d,e,f,g):
    ...
    print()
    guideline_axes1_lines=[i for i in guideline_axes[l].lines]
    ...
    if SW_global.stokearrow_on_off == 1:
        ...
        if stoke_arrow_flag_pos1 == 0:
            for i in range(delete_list_counter):
                ...
                if draw_type == 1:
                    guideline_axes1_plot.plot(c1, c2, color=SW_global.stokearrow_color_var, linewidth=1)
                else:
                    for ii in range(len(c1)):
                        guideline_axes1_plot.plot(c1[ii], c2[ii], color=SW_global.stokearrow_color_var, linewidth=1)
...
def call_composit_dot_multipleGuideline():
    for i in range(len(SW_global.axes_data)):
        ...
        compositedot_already_applied_array1=SW_global.axes_data[str(i)]["compositedot_already_applied_array"]
    ...
    if SW_global.startdot_on_off == 1:
        ...
        if startdot_flag_pos1 == 0:
            for i in range(delete_list_counter):
                ...
                guideline_axes1_plot.plot(c1, c2, marker='.', color=SW_global.startdot_color)
...
def call_start_dot_multiple_guideline():
    ...
    for i in range(len(SW_global.axes_data)):
        ...
        startdot_already_applied_array1=SW_global.axes_data[str(i)]["startdot_already_applied_array"]
        axw=SW_global.axes_data[str(i)]["axis_data"]
        ...
        print("I am in stoke arrow please check")
        ##stoke_arrow_flag_pos1,delete_list_temp,kern_value_array1,axw,compositedot_already_applied_array1,str(i),None
    # stoke_arrow_flag_pos1=a
    # delete_list_temp=b
    # kern_value_array1=c
    # guideline_axes1_plot=d
...
def decision_dot_For_MultiGuideLine(a,b,c,d,e,f,g): 
    ...
    if SW_global.decisiondot_on_off == 1:
        ...
        if decision_dot_flag_pos1 == 0:
            for i in range(delete_list_counter1):
                ...
                c1, c2, draw_type = Kern_add_help.kern_add_operation(c1, c2, krn)
                if draw_type==1:
                    guideline_axes_plot.plot(c1, c2, marker='.', color=SW_global.decisiondot_color, linewidth=0.1)
                else:
                    for ii in range(len(c1)):
                        guideline_axes_plot.plot(c1[ii], c2[ii], marker='.', color=SW_global.decisiondot_color,linewidth=0.1)
            ...
            for i in range(decision_dot_flag_pos1, delete_list_counter1):
                ...
                if draw_type == 1:
                    ...
                    for ii in range(len(c1)):
                        guideline_axes_plot.plot(c1[ii], c2[ii], marker='.', color=SW_global.decisiondot_color,
                                             linewidth=0.1)
    ...
    for i in guideline_axes1_lines:
        guideline_axes[l].lines.append(i)
    ...
    if SW_global.connectdot_on_off == 1:
        ...
        if connect_dot_flag_pos1 == 0:
            for i in range(delete_list_counter):
                ...
                if draw_type == 1:
                    d.plot(c1, c2, color=SW_global.connectingdot_color_var, linewidth=0.5)
                else:
                    for i in range(len(c1)):
                        d.plot(c1[i], c2[i], color=SW_global.connectingdot_color_var, linewidth=0.5)
...
def call_connect_dot_for_multipleGuideLine():
    ...
    for i in range(len(SW_global.axes_data)):
        ...
        connectdot_already_applied_array1=SW_global.axes_data[str(i)]["connectdot_already_applied_array"]
        axw=SW_global.axes_data[str(i)]["axis_data"]
        print(delete_list_temp)
        print(kern_value_array1)
        #print(letters_already_written1)
        print(connect_dot_flag_pos1)
        print(connectdot_already_applied_array1)
        print(axw)
...
def press(event):
    ...
    print(guideline_axes[l])
    #print(connectdot_already_applied_array)
    #print(decisiondot_already_applied_array)
    #print(compositedot_already_applied_array)
    #print(startdot_flag_pos)
    #print(stoke_arrow_flag_pos)
    #print(connect_dot_flag_pos)
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++ A-Z Input +++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    try:
        try:
            if(SW_global.kern_list[0]>16000):
               ...
               # for key in SW_global.axes_data:
                #    print("This is ok")
                #    print(SW_global.axes_data[key]["axis_data"])
                    #print(value)
                   # print(SW_global.axes_data[str(key)]["axes"])
                   # print(SW_global.axes_data[i]["axes_data"])
                    #print("This is value")

                #(SW_global.selector_data["1"]["axx"]).append(guideline_axes[0])
                #sq=[SW_global.left, SW_global.right, SW_global.bottom, SW_global.top]
                #SW_global.axes_data["1"]["pos"]=sq
                #print("This is selector dict")
                #print(SW_global.axes_data[guideline_axes[0]])
                #SW_global.selector_data["1"]["pos"]

                #print("This is a ")

                #print(a)

                #print("This is SW_global.axes_data")
...
def onclick(event):
    ...
    if event.inaxes == fig_axes:
        ...
        print("I got image axes")
        print(event.inaxes)
        print("This is guide line axes")
        print(guideline_axes[l])
