...
def reset_entire_page_data():
    global  letter_out_line_on_off,decision_dot_flag_pos,connect_dot_flag_pos,startdot_flag_pos,call_g,gl,gb,sl_t,sl_b,l,kern_value_array,delete_list
...
def multipage_data_controller(axesdata=None):
    print("I am in multipage data controller ")
    if(axesdata!=None):
...
#        newCreateGuideLine(1,None,None,None,None)
        ...
        if(len(temp)==0):
            newCreateGuideLine(1,None,None,None,None)
            if count1==0:
                guideline_axes[l].set_position([start_pos_x,start_pos_y,guidelin_axes[l].get_position().width,guideline_axes[l].get_position().height])        
        else:
            for j in range(len(temp)):
                print("This is temp",temp)
                newCreateGuideLine(1,None,None,None,None)
