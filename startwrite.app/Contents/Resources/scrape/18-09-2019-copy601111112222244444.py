...
def onclick2(event):
   ...
   # print("This is release coordinate")
        print("This is click x",SW_global.click_x)
        print("This is click y",SW_global.click_y)
        print(mainselector.corners)
        #print(mainselector.span)
        print("This is main selector objects ",dir(mainselector))
        check11=mainselector.corners[1]
        print(round(SW_global.click_y,2))
        print(check11)

        if(round(SW_global.click_y,2) in check11):
            print("ok")

        #elif(mainselector.cen)
    #print("This is click coordinate")
    #print()
    #round(number , uptodigit)
    return
...
def borderart_wp():
    ...
    def onselect1(event):
        ...
        if b1.get() == 3:
            ...
            print("Nothing")
        #### write here
        # print(SW_global.back_axes)
        # print(SW_global.back_axes.get_figure)
        # print(filename)
    ...
    def borderart_wp_close():
        if SW_global.ba_flag == True and SW_global.gdaxes == key_c:
            print("This is ",SW_global.back_axes)
            print(SW_global.back_axes.get_figure)
            print(filename)
            #default_guideline(guideline_axes[l])
            brd.DrawBorderArt(guideline_axes[l],fig1=guideline_axes[l].get_figure,image=filename)
            fig.canvas.draw()
...
def onclick(event):
    print("I am onclick checjk 4445556667")
...
def onselect(eclick, erelease):
    ...
    print("SW_global.left",SW_global.left)
    print("SW_global.right",SW_global.right)
    print("SW_global.top",SW_global.top)
    print("SW_global.bottom",SW_global.bottom)
