...
print("This is start *********************************************************************************************",SW_global.count_for_height)
    ...
    if SW_global.decisiondot_on_off == 1:
        ...
        if decision_dot_flag_pos == 0:
            ...
            for i in range(decision_dot_flag_pos, delete_list_counter):
                ...
                decisiondot_already_applied_array.insert(ltn, last_decision_dot_pos)
            fig.canvas.draw()
            print("This is decision dot already array",decisiondot_already_applied_array)
...
def color_letters_for_multipleguide():
    return
...
def press(event):
    ...
    print(SW_global.count_for_height,60*"*")
    ...
    if event.key == 'backspace':
        ...
        if SW_global.startdot_on_off == 1:
            ...
            fig.canvas.draw()
            startdot_flag_pos = startdot_flag_pos - 1
        print("This is check point 2",SW_global.count)
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++ A-Z Input +++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    try:
        try:
            print("*"*100)
            print(SW_global.count_for_height)
            if(SW_global.kern_list[0]>16000):
                ...
                delete_list.clear()
                print("*"*100)
                print("SW_global.count",SW_global.count_for_height)
                #temp=[i for i in guideline_axes[l].lines]
                newCreateGuideLine(1,None,None,None,None)
                print("This is after update ")
                print("SW_global",SW_global.count_for_height)
                ### adding all related data of recent axes
