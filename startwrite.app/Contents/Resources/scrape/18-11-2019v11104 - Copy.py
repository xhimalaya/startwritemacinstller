    ...
    if SW_global.current_font_size==None:
        ...
        if(pos11!=None):
           # print("This is width",pos11.height)
            guideline_axes[l]=plt.axes([pos11.x0, pos11.y0-pos11.height-(random.random()/100000)-0.04, 0.96, 0.15])
        else:
            guideline_axes[l]=plt.axes([old_l, old_b-height_axes, 0.96, 0.15])
    else:
       ...
       # print("This is width",pos11.height)
        ...
        if(SW_global.current_width!=None): 
            if(pos11!=None):
                ...
                guideline_axes[l]=plt.axes([pos11.x0, pos11.y0-pos11.height-(random.random()/100000),0.96 , SW_global.current_width])
            else:
                guideline_axes[l]=plt.axes([old_l, old_b-height_axes, 0.96, SW_global.current_width])
