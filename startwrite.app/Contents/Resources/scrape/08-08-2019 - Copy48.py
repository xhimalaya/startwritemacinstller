...
def add_letter_with_mouse_and_from_end(axesdata=None,delete_list=None,pos=None,event_key=None,kern_value_array=None):
    ...
    try:
        ...
        print("I am on add letter check point 1")
...
################ Checking for wheather multiple guide line is needed or not #################
        ...
        #     fdelete_list=[]
        #     fkern_value_array=[]
        #     fdelete_list,fkern_value_array=add_letter_with_mouse_and_from_end(axesdata=SW_global.current_axes,pos=SW_global.current_pos,
        #         event_key=event.key,kern_value_array=temp_kern_value_array,delete_list=temp_delete_list)
