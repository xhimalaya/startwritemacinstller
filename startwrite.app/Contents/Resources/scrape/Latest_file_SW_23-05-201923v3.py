...
# ++++++++++++++++++++++++++++++++++++++++++++++++++ A-Z Input +++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    try:
        ...
        x_max = manuscript.x_max[user_input]
        kern_x = SW_global.kern_list[0]
        ##### Place where i have been added the brezier
        print("#"*60)
        #######################himalaya############################
       # c1=[]
       # c2=[]
        print(user_input)
        if(user_input=="A" or user_input=="B" or user_input=="E" or user_input=="Y"):
            print("I am in check point1")
            if color_letter_features_on_off:
                c1,c2=manuscript_Color_Letters.return_manuscript_color_fonts(user_input)
