...
global back_axes
def reset_main_selector1(mainselector):

    mainselector=widgets.RectangleSelector(SW_global.back_axes, onselect,
                                         drawtype='box', interactive=True,
                                         spancoords='pixels', minspany=110, maxdist=50, button=1,
                                         rectprops=dict(facecolor='white', linestyle='--',
...
def newCreateGuideLine(n,a,b,c,d):
   ...
   #     SW_global.count_for_height=1
    ...
    if(pos11!=None):
        guideline_axes[l]=plt.axes([pos11.x0, pos11.y0-0.15, 0.98, 0.15])
    else:
