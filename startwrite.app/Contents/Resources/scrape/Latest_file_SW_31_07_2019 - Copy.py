...
def onrelease(event):
    ...
    ###### CHANGE of cursor #######
   # for i in range(len(SW_global.cursor_pos)):
    #    if(i<len(SW_global.cursor_pos)-1):
     #       if((SW_global.cursor_pos[i]<=end_point) and (SW_global.cursor_pos[i+1]>=end_point)):
      #          pos2=i-1
       #         cur_temp_end=pos2
        #        break
  ...
  #  print("TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT")
    ...
    #	print("This is for check point colorwrite")
    	...
    	for i in range(Starting_loop_point1,ending_loop_point1):
    		k=SW_global.g_val.lines[i]
    		k.set_color('r')
    		SW_global.g_val.lines[i].set_color('r')
    #else:
...
def composite_dot():
    ...
    if SW_global.stokearrow_on_off == 1:
        ...
        print("This is composite dot 1")
        print("This is before operation")
        ...
        if(int(SW_global.click_x)==int(SW_global.release_x)):
            ...
            if(len(k1)>0):
              ...
              #  SW_global.letters_already_written.clear()
                ...
                print(delete_list22)
                #delete_list.clear()
                #print(SW_goobal.letters_already_written)
        ...
        if(pos11_start>=0):
            if(pos22_end>=0):
              #  print(pos11_start)
               ...
               # print("I am in cut invisible line")
                temp_array=[]
                   ...
                   # for i in range(Starting_loop_point1,ending_loop_point1):
                    ...
                    #fig.canvas.draw()
                     ...
                     #   for i in range(len(SW_global.letters_already_written)):
                      #      print("I am in loop part")
                       #     if((i>=int(pos11_start)) and (i<=int(pos22_end))):
                        #        print("This is i")
                         #       print(i)
                          #      print("This is pos1 and pos2")
                           #     print(pos11_start)
                            #    print(pos22_end)
                             #   skip1=0
                           # else:
                            #    print("I am in else part")
                             #   print(temp_array)
                              #  temp_array.append(SW_global.letters_already_written[i])
                    #print(temp_array)
                    #print(pos1i)
                    #print(pos2i)
                    #print("This is kern x")
                    #print(SW_global.kern_list)
                    #reverse_kern_list=SW_global.kern_list
                    #reverse_kern_list.reverse()
                    #print(reverse_kern_list)
                    #SW_global.letters_already_written=[]
                    #SW_global.letters_already_written=temp_array
                    #print(SW_global.letters_already_written)
                    #print(delete_list)
                    delete1=[]
