...
def restaurar_wn():
    ...
    # ab=Button(sub,text=sub.winfo_id(),command=sub.destroy)
    # ab.pack()
    ...
    print("Hello , multi windows is working")
    mainselector.update()
...
def onrelease(event):
    ...
    try:
        ...
        print("hi i am exception from line no 595:",e)
        pass
        ...
        if(key==10000):
            ...
            for j in range(len(delete_list1)):
                ...
                try:
                    ...
                    print("Hi i am a error from line number 6949>>",e)
                fig.canvas.draw()
                final_enrty_pos = len(SW_global.letters_already_written)
                final_letter_pos = len(guideline_axes[l].lines)
                SW_global.letters_already_written.insert(final_enrty_pos, final_letter_pos)
...
def add_letter_with_mouse_and_from_end(axesdata=None,delete_list=None,pos=None,event_key=None,kern_value_array=None):
    ...
    # -----------------------------------------------------------------------------------------------------
        ...
        print("Hello i am error from line number 7547>>",e)
        pass
    return 
...
def cut_addletter(user_input):
    try:
        ...
        print("Hi i am error from line 7793",e)
...
def press(event):
    try:
        ...
        print("Hi i m error from press function>> ",e)                    
...
################ Checking for wheather multiple guide line is needed or not #################
        try:
            ...
            print("Hello i am error from line no 8083>> ",e)
            pass
        ...
        print("Hi i am keyerror from line no 8106")
        pass
          ...
          #  print("Check point 4")
           ...
           # print("check point 5")
            ...
            try:
                ...
                print("I am error from line number 8422",e)
...
# Rectangle Selector is Define Her
