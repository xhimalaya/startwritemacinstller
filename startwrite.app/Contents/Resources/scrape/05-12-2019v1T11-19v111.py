...
def reset_entire_page_data():
    global  letter_out_line_on_off,decision_dot_flag_pos,connect_dot_flag_pos,startdot_flag_pos,call_g,gl,gb,sl_t,sl_b,l,kern_value_array,delete_list,mainselector
...
def multipage_create(writingareaframe=None):
    ...
    multipage_data_controller(axesdata=SW_global.g_val)
