...
def cut_add_letter_from_any_position2(delete_list1=None,current_axes=None,key=None):
    ...
    try:
        if(key==10000):
            ...
            temp_guideline_axes=None
            temp_guideline_axes=SW_global.axes_data[str(key)]["axis_data"]
            count_of_axes=key
            kern_value_array2=[0]
            ...
            for k10 in range(len(delete_list1)):
                ...
                print("axes is :",temp_guideline_axes)
                ...
                if(kern_list2[0]>15500):
                    ...
                    if(count_of_axes>len(SW_global.axes_data)-1):
                        ...
                        if(guideline_flag>0):
                            ...
                            a["recent_input_list"]=[j for j in SW_global.recent_input_list]
                    ...
                    ##        print("check point delta 2")
                      ...
                      ##  print("check point delta 3")
                        ...
                        temp_guide_line_axes=guideline_axes[l]
                        ...
                        if(count_of_axes<len(SW_global.axes_data)-1):
                            ...
                            temp_guide_line_axes=SW_global.axes_data[str(count_of_axes)]["axis_data"]
                        else:
                            print("check point 28")
                            temp_guideline_axes=guideline_axes[l]
             ...
             #   print("check point 2")
                ...
                if(draw_type_color_letter==1):
                    ...
                    if(color_letter_features_on_off):
                        ...
                        temp_o=temp_guideline_axes.plot(c1, c2, color=SW_global.first_letter_background_color, linewidth=0.7, dashes=(d1, d2), alpha=alp)
                        for k2 in temp_o:
                            g_val2.append(k2)
                    else:
                        print("check point 34")
                        temp_o=temp_guideline_axes.plot(c1, c2, color='black', linewidth=0.7, dashes=(d1, d2), alpha=alp)
                        for k2 in temp_o:
                            g_val2.append(k2)
                else:
                    ...
                    if(color_letter_features_on_off):
                        ...
                        for i in range(n):
                            if i==0:
                                temp_o.clear()
                                temp_o=temp_guideline_axes.plot(c1[i], c2[i], color=SW_global.first_letter_background_color, linewidth=0.7, dashes=(d1, d2), alpha=alp)
                                for k2 in temp_o:
                                    g_val2.append(k2)
                            if i==1:
                                temp_o.clear()
                                temp_o=temp_guideline_axes.plot(c1[i], c2[i], color=SW_global.second_letter_background_color, linewidth=0.7, dashes=(d1, d2), alpha=alp)
                                for k2 in temp_o:
                                    g_val2.append(k2)
                            if i==2:
                                temp_o.clear()
                            ...
                            if i==3:
                                temp_o.clear()
                                temp_o=temp_guideline_axes.plot(c1[i], c2[i], color=SW_global.forth_letter_background_color, linewidth=0.7, dashes=(d1, d2), alpha=alp)
                                for k2 in temp_o:
                                    g_val2.append(k2)
                    else:
                        ...
                        for i in range(n):
                            temp_o.clear()
                            temp_o=temp_guideline_axes.plot(c1[i], c2[i], color='black', linewidth=0.7, dashes=(d1, d2), alpha=alp)
                            for k2 in temp_o:
                                g_val2.append(k2)
                ...
                plot_data=temp_guideline_axes.plot(cursor_x1, cursor_y, color='black', linewidth=0.6, dashes=(3, 4))
                SW_global.single_click_data=plot_data[0]
                k2=temp_guideline_axes.plot(cursor_x1, cursor_y, color='black', linewidth=0.6, dashes=(3, 4))
...
def press(event):
    ...
    if event.key == 'backspace':
        backspaceOperation()     #### backspace function has some bug need to check with respected to commented back space check with commented back space which works well ####
    #     if(SW_global.single_click_data!=None):
    #         SW_global.single_click_data.set_visible(False)
    #     len1 = len(SW_global.letters_already_written)
    #     len2 = len1 - 1
