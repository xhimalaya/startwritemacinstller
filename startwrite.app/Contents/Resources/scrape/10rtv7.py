...
def select_string_for_copy_paste(pos1=None,start_axes=None,start_axes_key=None,pos2=None,end_axes=None,end_axes_key=None):
    try:
        ...
        print("Hi i am error from 562 ",e)
        pass
    return copy_string
...
def onrelease(event):
        ...
        if(len(SW_global.axes_data)>0):
            ...
            if(len(SW_global.box_data)>0):
                for j in range(len(SW_global.box_data)):
                    ...
                    if(event.inaxes in check_axes_list):
    ...
    try:
        ...
        print("Hi i am error from 878 ",e)
        pass
    try:
        ...
        print("Hi i am error from 886 ",e)
        pass
    try:
        for i in SW_global.cursor_data:
            i.set_visible(False)
    except Exception as e:
        print("Hi i am error from 892",e)
        pass
    ...
    try:
        ...
        print("Hi i am error from 977 ",e)
        pass
    ...
    if(SW_global.click_x==SW_global.release_x):
        ...
        try:
            ...
            print("Hi i am error from 1192",e)
            pass
                ...
                if(end_ce_axes==SW_global.axes_data[str(j)]["axis_data"]):
                    if(len(SW_global.axes_data[str(j)]["cursor_data"])>0):
                        ...
                        try:
                            ...
                            print("Hi i am error from 1223 ",e)
                            pass
                        break
        ...
        if(start_ce_axes==guideline_axes[l]):
            ...
            try:
                ...
                print("Hi i am error from  1244 ",e)
                pass
        else:
            for j in range(len(SW_global.axes_data)):
                if((SW_global.axes_data[str(j)]["axis_data"])==start_ce_axes):
                    ...
                    try:
                        ...
                        print("Hi i am error from 1260 ",e)
                        pass
    return
            ...
            if(SW_global.text_flow_axes1 in check_axes_list):
                ...
                for k5 in SW_global.entire_delete_list_for_one_page:
                    try:
                        ...
                        print("Hi i am error from 1579",e)
...
def color_letter_menu_wtp():
    ...
    def background_close():
        ...
        try:
            ...
            print("Hi i am error from 5837 ",e)
            pass
        if color_letter_features_on_off:
            ...
            try:
                ...
                print("Hi i am error from 5848 ",e)
                pass
            main12345()
            try:
                SW_global.single_click_data.set_visible(True)
            except Exception as e:
                print("Hi i am error from 5854 ",e)
                pass
...
def color_letter_continues_write():
    ...
    try:
        ...
        print("Hi i am error from 6027 ",e)
        pass
...
def main12345():
    ...
    if color_letter_features_on_off == 0:
        ...
        try:
            ...
            print("Hi i am error from 6153 ",e)
            pass
# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> END <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
def font_wp():
    ...
    val2 = ['118','10','12','14','16','18','20','22','24','30','36','42','48','54','60','66','72','96','128','144','160','192']
...
# -----------------------------------------------------------------------------------------------------
        ...
        print("Hi i am error from 7286 ",e)
        pass
...
def add_letter_with_mouse_and_from_end2(axesdata=None,delete_list1=None,pos=None,event_key=None,kern_value_array=None):
    try:
        ...
        print("Hi i am error from 7580 ",e)
        pass
    return
...
def cut_add_letter_from_any_position2(delete_list1=None,current_axes=None,key=None):
    ...
    try:
        if(key==10000):
            ...
            ####################################################################################
                ...
                try:
                    ...
                    print("Hi i am error from 7729 ",e)
                fig.canvas.draw()
                final_enrty_pos = len(SW_global.letters_already_written)
                final_letter_pos = len(guideline_axes[l].lines)
                SW_global.letters_already_written.insert(final_enrty_pos, final_letter_pos)
            ...
            print("Jao ghar jao , bahat ho gaya")
        ...
        print("Hi i am error from 8012 ",e)
    return
...
# -----------------------------------------------------------------------------------------------------
        ...
        print("Hi i am error from 8348 ",e)
        pass
    return
...
def cut_addletter(user_input):
    try:
        ...
        print("hi i am error from 8609",e)
...
def newCreateGuideLine(n,a,b,c,d):
    ...
    img = plt.imread('icons/guideline.PNG')
    guideline_axes[l].imshow(img, extent=[0.0004, 0.0005, 0.0006, 0.002])
    guideline_axes[l].tick_params(axis='both', which='both', bottom='on', top='off', labelbottom='off',
                                      right='off', left='off', labelleft='off')
    for ln in ['top', 'right', 'left', 'bottom']:
        guideline_axes[l].spines[ln].set_linewidth(0)
    default_guideline(guideline_axes[l])
...
def press(event):
    ...
    try:
        ...
        print("hi i am error from 8663",e)
        pass
    global init_letter_pos, final_letter_pos, startdot_flag_pos
...
################ Checking for wheather multiple guide line is needed or not #################
        try:
            ...
            print("hi i am error from 8900 ",e)
            pass
        ...
        if(len(str(event.key))==1):
            try:
                ...
                print("hi i am error from 8920 ",e)
                pass
    except KeyError:
        print("hi i am keyerror from 8925")
        pass
# -----------------------------------------------PRESS EVENT END-------------------------------------------
def my_draw(c1, c2):
        ...
        try:
            ...
            try:
               ...
               # visible_item.set_visible(True)
                ...
                print("hi i am error from 9087",e)
                pass
            import numpy as np
...
def add_letter_after_backspace(key=None,delete_list1=None):
    if(key==10000):
        ...
        try:
            ...
            print("hi i am error from 9570 ",e)
            pass
        ####### Testing purpose #######
        return
    # # return delete_list1,kern_value_array
    ...
    try:
        ...
        try:
           ...
           # visible_item.set_visible(True)
            ...
            print("hi i am error from 9654 ",e)
            pass
        import numpy as np
        ...
        print("hi i am error from 9671 ",e)
        pass
    return
...
def set_text_for_text_flow():
    if(SW_global.text_flow_axes1==None):
        if(SW_global.text_flow_axes2==None):
            SW_global.entire_delete_list_for_one_page.clear()
            if(SW_global.temp_axes!=None):
                SW_global.text_flow_axes1=SW_global.temp_axes
                for j in delete_list:
                    SW_global.entire_delete_list_for_one_page.append(j)

        else:
            if(SW_global.temp_axes!=SW_global.text_flow_axes2):
                SW_global.text_flow_axes1=SW_global.temp_axes
        ...
        if(SW_global.text_flow_axes2==None):
            if(SW_global.temp_axes!=None):
                SW_global.text_flow_axes2=SW_global.temp_axes
                temp_array=[]
                for j in range(len(SW_global.axes_data)):
                    for k in SW_global.axes_data[str(j)]["delete_list"]:
                        temp_array.append(k)
                ...
                for j in delete_list:
                    temp_array.append(j)
                SW_global.entire_delete_list_for_one_page.clear()
                SW_global.entire_delete_list_for_one_page=temp_array.copy()

        else:
            if(SW_global.text_flow_axes1==SW_global.temp_axes):
                SW_global.text_flow_axes1=None
...
def combo_box_select(event):
    global sl_b,SW_global, textfont_size
    textfont_size = combo_box.get()
    SW_global.scl = textfont_size[0]
    sl_b = textfont_size[1]
    writingareaframe()
    fig.canvas.mpl_connect('key_press_event', press)
    fig.canvas.mpl_connect('button_press_event',onclick2)
    fig.canvas.mpl_connect('button_release_event',onrelease)
...
text_font = ('Manuscript', '12')
try:
    size_font= tk.StringVar()
except:
    size_font=StringVar()
main_frame = tk.Frame(propertybarframe)

    # print("67"*60)
    # print("sl_b",sl_b,"SW_global.scl",SW_global.scl)
    # # return [x1,y1]
combo_box = ttk.Combobox(main_frame,textvariable = size_font, font=text_font, width=4,takefocus=False,exportselection=0)
propertybarframe.option_add('*TCombobox*Listbox.font', text_font)
combo_box.set('48')
#fig.canvas.mpl_connect('key_press_event', press)
combo_box.pack(side=LEFT)
