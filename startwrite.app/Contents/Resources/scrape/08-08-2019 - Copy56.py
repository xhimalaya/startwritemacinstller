...
def onrelease(event):
    ...
    #         return
    #     else:
    #         temp_pos=(SW_global.axes_data[str(cur_temp_start)]["cursor_pos"])[-1]
    #        # import numpy as np

    #         cursor_y=np.linspace(-900,1500,500)

    #         cursor_x=list(np.full((500),temp_pos))
    ...
    #        # SW_global.single_click_data=(SW_global.axes_data[str(cur_temp_start)]["cursor_data"])[-1]
